                            ...
                            <div class="relative">
                                <input wire:model="name" type="text" id="name" aria-describedby="name_help"
                                    @class([
                                        ...
                                        'dark:border-red-500 border-red-600 dark:focus:border-red-500 focus:outline-none focus:ring-0 focus:border-red-600' => $errors->has(
                                            'name'),
                                        'dark:border-gray-500 border-gray-300 dark:focus:border-primary-500 focus:border-primary-600' => !$errors->has(
                                            'name'),
                        ...
                        <div>
                            <div class="relative">
                                ...
                                <label for="email" @class([
                                    'absolute text-md duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white dark:bg-gray-900 px-2 peer-focus:px-2 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4',
                                    'text-red-600 dark:text-red-500' => $errors->has('email'),
                                    'text-gray-900 dark:text-white' => !$errors->has('email'),
                                ])>{{ __('Email') }}</label>
                            </div>
                            @error('email')
                                <p id="email_help" class="mt-2 text-xs text-red-600 dark:text-red-400"> {{ $message }}</p>
                            @enderror
                        </div>
                        <div>
                            <div class="relative">
